...
import com.droidzilla.moboswatch.R;
...
/**
 * The watch-side config activity for {@link com.example.android.wearable.watchface.DigitalWatchFaceService}, which allows for setting the
 * background color.
 */
